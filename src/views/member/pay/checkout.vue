  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      ...
      <div class="wrapper" v-if="order">
        ...
        <CheckoutAddress @change="changeAddress" :userAddress='order.userAddresses'></CheckoutAddress>
        <!-- 商品信息 -->
...
import { createOrder, submitOrders } from '@/api/order'
  ...
  setup () {
    ...
    const submitOrder = () => {
      if (!reqParams.addressId) {
        return proxy.$message({ text: '请选择地址' })
      }
      submitOrders(reqParams).then(res => {
